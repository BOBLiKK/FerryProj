...
public class MessageConstant {
    ...
    public static final String START_LOADING_MESSAGE = "⚓ Ferry arrived empty. Start loading...";
    public static final String FERRY_LEAVES_MESSAGE = "🚢 Ferry leaves. Number of vehicles on board:  ";
    public static final String FINISH_JOB_MESSAGE = "✅ Job done forever.";
